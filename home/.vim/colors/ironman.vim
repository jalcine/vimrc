...
hi WarningMsgildMenu         gui=NONE guifg=Black   guibg=Orange ctermfg=0
...
" Cursor
hi Cursor                    gui=NONE guifg=#ffffff guibg=#DE7171 ctermfg=255
hi lCursor                   gui=NONE guifg=#f8f8f8 guibg=#8000ff
hi CursorIM                  gui=NONE guifg=#f8f8f8 guibg=#8000ff
hi CursorLine                gui=NONE guifg=NONE    guibg=#f6f6f6 ctermfg=NONE
hi CursorColumn              gui=NONE guifg=NONE    guibg=#F9F9F9 ctermfg=NONE
...
hi LineNr                    gui=NONE guifg=#FFFFFF guibg=#C0D0E0 ctermfg=255
...
hi MatchParen                gui=NONE guifg=NONE    guibg=#9FFF82 ctermfg=NONE
...
hi Identifier                gui=NONE  guifg=#339933 guibg=NONE ctermbg=NONE
hi Ignore                    gui=NONE guifg=#f8f8f8 guibg=NONE ctermbg=NONE
hi Number                    gui=NONE guifg=#087B4D
hi PreProc                   gui=NONE guifg=#0070e6 guibg=NONE ctermbg=NONE
hi Special                   gui=NONE guifg=#0000ff guibg=#ccf7ee
hi Delimiter                 gui=BOLD guifg=#A8360F guibg=NONE ctermbg=NONE
hi Todo                      gui=NONE guifg=#ff0070 guibg=#ffe0f4
hi Type                      gui=NONE guifg=#eb7950 guibg=NONE
hi Underlined                gui=UNDERLINE guifg=#0000ff guibg=NONE ctermbg=NONE
