...
augroup autosourcecfg
  au!
  au BufWritePost $MYVIMRC      call s:reload_config()
  au BufWritePost .local.vimrc  call s:load_current_buffer()
  au BufReadPost  *tmux*        setl ft=tmux
...
function! s:reload_tmux()
  ...
  call system("tmux display-message 'Configuration of tmux reloaded using ". expand('%') . ".'")
endfunction
